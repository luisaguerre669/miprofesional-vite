const categoriesData = [
  ...
  },
  {
    ...
    commerceSubcategories: {
      minorista: [
        { title: 'Farmacia', slug: 'com-farmacia', description: 'Farmacias, perfumerías y productos de cuidado personal', image: 'https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?w=600&q=80', icon: 'Heart' },
        { title: 'Óptica', slug: 'com-optica', description: 'Ópticas y centros ópticos', image: 'https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?w=600&q=80', icon: 'Eye' },
        { title: 'Kiosco', slug: 'com-kiosco', description: 'Kioscos, maxikioscos y golosinas', image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600&q=80', icon: 'Store' },
        { title: 'Rotisería', slug: 'com-rotiseria', description: 'Rotiserías, comidas preparadas y take away', image: 'https://images.unsplash.com/photo-1555244162-803834f70033?w=600&q=80', icon: 'ChefHat' },
        { title: 'Tienda', slug: 'com-tienda', description: 'Tiendas de ropa, accesorios y artículos en general', image: 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=600&q=80', icon: 'Shirt' },
        { title: 'Perfumería', slug: 'com-perfumeria', description: 'Perfumes, cosméticos y productos de belleza', image: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=600&q=80', icon: 'Sparkles' },
        { title: 'Almacén', slug: 'com-almacen', description: 'Almacenes de barrio y comercios de cercanía', image: 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&q=80', icon: 'Store' },
        { title: 'Panadería', slug: 'com-panaderia', description: 'Pan artesanal, facturas y panificados', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80', icon: 'ChefHat' },
        { title: 'Carnicería', slug: 'com-carniceria', description: 'Carnes vacunas, porcinas y avícolas', image: 'https://images.unsplash.com/photo-1559847844-5315695dadae?w=600&q=80', icon: 'Store' },
        { title: 'Verdulería', slug: 'com-verduleria', description: 'Frutas, verduras y productos de granja', image: 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&q=80', icon: 'Apple' },
        { title: 'Heladería', slug: 'com-heladeria', description: 'Helados artesanales y postres helados', image: 'https://images.unsplash.com/photo-1501443762994-82bd5dace89a?w=600&q=80', icon: 'Snowflake' },
        { title: 'Librería', slug: 'com-libreria', description: 'Librerías, papelería y artículos de oficina', image: 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=600&q=80', icon: 'BookOpen' },
        { title: 'Juguetería', slug: 'com-jugueteria', description: 'Juguetes, juegos y artículos infantiles', image: 'https://images.unsplash.com/photo-1558060370-d644479cb6f7?w=600&q=80', icon: 'ToyBrick' },
        { title: 'Ferretería', slug: 'com-ferreteria', description: 'Ferreterías y artículos para el hogar', image: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600&q=80', icon: 'Wrench' },
        { title: 'Bazar', slug: 'com-bazar', description: 'Artículos para el hogar, cocina y bazar', image: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=600&q=80', icon: 'Store' },
        { title: 'Mueblería', slug: 'com-muebleria', description: 'Muebles, colchones y decoración', image: 'https://images.unsplash.com/photo-1618220179428-22790b461013?w=600&q=80', icon: 'Home' },
        { title: 'Electrodomésticos', slug: 'com-electro', description: 'Venta de electrodomésticos y electrónicos', image: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=600&q=80', icon: 'Monitor' },
      ],
      mayorista: [
        { title: 'Alimentos por mayor', slug: 'com-alimentos-mayorista', description: 'Venta mayorista de alimentos y bebidas', image: 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&q=80', icon: 'Store' },
        { title: 'Bebidas por mayor', slug: 'com-bebidas-mayorista', description: 'Distribución mayorista de bebidas', image: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=600&q=80', icon: 'Wine' },
        { title: 'Distribuidora', slug: 'com-distribuidora', description: 'Distribución de productos varios', image: 'https://images.unsplash.com/photo-1603796846097-bee99e4a601f?w=600&q=80', icon: 'Truck' },
        { title: 'Limpieza industrial', slug: 'com-limpieza-industrial', description: 'Productos de limpieza para empresas e industrias', image: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=600&q=80', icon: 'SprayCan' },
      ],
      mixto: [
        { title: 'Almacén/Supermercado', slug: 'com-mixto-almacen', description: 'Almacenes y supermercados con venta minorista y mayorista', image: 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&q=80', icon: 'Store' },
        { title: 'Tienda multiplataforma', slug: 'com-mixto-tienda', description: 'Tienda física con canal mayorista online', image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=600&q=80', icon: 'Shirt' },
        { title: 'Depósito/comercio dual', slug: 'com-mixto-dual', description: 'Comercio con depósito y venta al público + por volumen', image: 'https://images.unsplash.com/photo-1553413077-190dd3058711?w=600&q=80', icon: 'Building2' },
      ]
    },
