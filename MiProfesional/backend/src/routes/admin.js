...
router.post("/seed-categories", async (req, res) => {
  try {
    ...
    const categories = [
      ...
      { title: "24-7", slug: "24-7", description: "Profesionales disponibles 24 horas, 7 días a la semana.", image: "https://images.unsplash.com/photo-1587745416684-47953f16fdd1?w=800&q=80", icon: "AlertTriangle", metadata: { color: "#dc2626", featured: true, emergency: true }, sortOrder: 3 },
